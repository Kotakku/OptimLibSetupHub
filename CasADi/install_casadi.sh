...
cmake .. -DCMAKE_BUILD_TYPE=Release -DWITH_IPOPT=ON -DWITH_HPIPM=ON -DWITH_BLASFEO=ON -DWITH_BUILD_HPIPM=ON -DWITH_BUILD_BLASFEO=ON -DWITH_LAPACK=ON -DWITH_QPOASES=ON -DWITH_WORHP:BOOL=OFF -DWITH_SNOPT=ON
make -j4
sudo make install